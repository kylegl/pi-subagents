...
export const SubagentParams = Type.Object({
	...
	chainDir: Type.Optional(Type.String({ description: "Persistent base directory for chain artifacts (takes precedence over taskId/taskRoot/taskMode)." })),
	taskId: Type.Optional(Type.String({ description: "Logical task id for chain artifact routing. Uses <taskRoot>/<taskId> when chainDir is not set." })),
	taskRoot: Type.Optional(Type.String({ description: "Base directory for taskId routing. Default: <cwd>/.agents/tasks" })),
	taskMode: Type.Optional(Type.String({ description: "taskId routing mode: 'direct' writes to <taskRoot>/<taskId>; 'run' writes to <taskRoot>/<taskId>/<runId>. Default: 'direct' when taskId is provided." })),
